  ...
  <div class="container-fluid no-padding">
    <div class="row">
      ...
      <div class="col-md-6">
          <div class="panel">
              <div class="panel-body">
                  <ve-line :data="pusherData" :settings="cntSettings" :legend-visible="false" :title="{text: '拉流统计', left: 'center'}"></ve-line>
              </div>
          </div>
      </div>      
      <div class="col-md-6">
          <div class="panel">
              <div class="panel-body">
                  <ve-line :data="playerData" :settings="cntSettings" :legend-visible="false" :title="{text: '播流统计', left: 'center'}"></ve-line>
              </div>
          </div>
      </div>      
    </div>
